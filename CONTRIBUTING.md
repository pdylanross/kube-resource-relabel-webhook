...
If you think you have found a security issue, please do not mention it in this repository. Instead, send an email to `dylan.ross@avanibbles.com` with as many details as possible.
...
1. All lints must pass.
2. The maintainer have final say over code quality debates.
3. Comment the why, not the how.
4. Recognize that we're all [Grug Brained](https://grugbrain.dev/)